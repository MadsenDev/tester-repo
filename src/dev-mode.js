...
Object.assign(badge.style, {
  ...
  zIndex: "9999",
  padding: "7px 10px",
  border: "1px solid rgba(255,224,106,.65)",
  borderRadius: "999px",
  background: "rgba(20,15,4,.86)",
  color: "#ffe06a",
  font: "800 10px system-ui",
  letterSpacing: ".12em",
  pointerEvents: "none",
  boxShadow: "0 0 18px rgba(255,224,106,.2)",
  display: "none",
  whiteSpace: "nowrap",
});
...
function toggle() {
  nativeSetItem.call(localStorage, DEV_KEY, active() ? "0" : "1");
  refresh();
  if (navigator.vibrate) navigator.vibrate(active() ? [35, 35, 70] : 35);
}
refresh();
